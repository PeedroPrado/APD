...
const MapComponent: React.FC<Props> = ({ dados, agrupamento }) => {
  ...
  const opcoes = useMemo(
    () => [...new Set(dadosAreaQueimada.map(d => normalizar(agrupamento === 'estado' ? d.estado : d.bioma)))],
    [dadosAreaQueimada, agrupamento]
  );
